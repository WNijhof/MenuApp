...
const translations = {
  en: {
    ...
    "day.swapToType": "Swap for a specific type of dish",
    "day.swapToTypePlaceholder": "e.g. lasagna, meatballs, tomato soup",
    "day.swapToTypeButton": "Swap",
    ...
    "recipes.addByUrlTab": "Add via link",
    "recipes.addManualTab": "Add manually",
    "recipes.manualHelp": "Type in your own recipe — title, ingredients (one per line) and steps. Its ingredients are automatically included in the shopping list whenever the recipe is used in a week.",
    "recipes.manualTitlePlaceholder": "Recipe title",
    "recipes.manualIngredientsPlaceholder": "Ingredients, one per line, e.g.\n500 g ground beef\n1 onion\n1 can chopped tomatoes",
    "recipes.manualInstructionsPlaceholder": "Steps, one per line",
    "recipes.manualServingsPlaceholder": "Servings (optional), e.g. 4 people",
    "recipes.manualCourseAuto": "Course: auto-detect from title",
    "recipes.manualCancelEdit": "Cancel",
    "recipes.manualBadge": "own recipe",
    "recipes.ingredients": "Ingredients",
    "recipes.instructions": "Instructions",
    "recipes.noIngredients": "No ingredients listed.",
    "recipes.noInstructions": "No instructions listed.",
  ...
  nl: {
    ...
    "day.swapToType": "Wissel naar een specifiek type gerecht",
    "day.swapToTypePlaceholder": "bv. lasagne, gehaktbal, tomatensoep",
    "day.swapToTypeButton": "Wissel",
    ...
    "recipes.addByUrlTab": "Toevoegen via link",
    "recipes.addManualTab": "Zelf toevoegen",
    "recipes.manualHelp": "Typ je eigen recept in — titel, ingrediënten (één per regel) en bereidingswijze. De ingrediënten komen automatisch op de boodschappenlijst terecht zodra het recept in een week wordt gebruikt.",
    "recipes.manualTitlePlaceholder": "Titel van het recept",
    "recipes.manualIngredientsPlaceholder": "Ingrediënten, één per regel, bv.\n500 g gehakt\n1 ui\n1 blik tomatenblokjes",
    "recipes.manualInstructionsPlaceholder": "Bereidingsstappen, één per regel",
    "recipes.manualServingsPlaceholder": "Aantal personen (optioneel), bv. 4 personen",
    "recipes.manualCourseAuto": "Gang: automatisch bepalen op basis van titel",
    "recipes.manualCancelEdit": "Annuleren",
    "recipes.manualBadge": "eigen recept",
    "recipes.ingredients": "Ingrediënten",
    "recipes.instructions": "Bereidingswijze",
    "recipes.noIngredients": "Geen ingrediënten opgegeven.",
    "recipes.noInstructions": "Geen bereidingswijze opgegeven.",
